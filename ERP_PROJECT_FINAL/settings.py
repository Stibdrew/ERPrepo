"""
Django settings for ERP_PROJECT_FINAL project.
...
ALLOWED_HOSTS = ['.herokuapp.com']# Use environment variable
...
ROOT_URLCONF = 'ERP_PROJECT_FINAL.urls'
...
WSGI_APPLICATION = 'ERP_PROJECT_FINAL.wsgi.application'
